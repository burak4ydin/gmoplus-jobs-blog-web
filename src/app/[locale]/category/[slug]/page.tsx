...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      title: `${name} — GMOPlus Jobs Blog`,
      description: `${name} kategorisindeki kariyer makaleleri.`,
    };
  } catch {
    return { title: "Kategori — GMOPlus Jobs Blog" };
  }
}
    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <header className="mb-8">
        <div className="inline-flex items-center gap-2 mb-3">
          <span className="text-xs font-semibold text-teal-600 bg-teal-50 px-2.5 py-1 rounded-full">KATEGORİ</span>
        </div>
