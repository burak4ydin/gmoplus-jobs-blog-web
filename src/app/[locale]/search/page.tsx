        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              name="q"
              defaultValue={q}
              placeholder="Kariyer makalesi ara..."
              className="w-full rounded-xl border border-gray-200 py-3 pl-10 pr-4 text-sm focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
            />
          </div>
          <button
            type="submit"
            className="px-6 py-3 bg-teal-600 text-white rounded-xl text-sm font-semibold hover:bg-teal-700 transition-colors"
          >
            Ara
          </button>
        </div>
