    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <header className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-xs font-semibold text-violet-600 bg-violet-50 px-2 py-0.5 rounded">KARİYER</span>
        ...
        <div className="flex items-center gap-3 text-sm text-gray-400 mt-4 flex-wrap">
          ...
          {post.isEditorPick && <span className="text-violet-600 font-medium">Editörün Seçimi</span>}
        </div>
      </header>

      <article
        className="prose prose-gray max-w-none prose-headings:font-bold prose-a:text-violet-600 prose-img:rounded-xl"
      ...
      <div className="mt-10 pt-8 border-t border-gray-100">
        <div className="bg-violet-50 rounded-xl p-6 flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-violet-900 mb-1">GMOPlus Jobs</p>
            <p className="text-xs text-violet-700">İş ilanları ve kariyer fırsatları için platformumuzu keşfedin.</p>
          </div>
          <a
            href="https://jobs.gmoplus.com"
            className="shrink-0 ml-4 px-4 py-2 bg-violet-600 text-white text-xs font-semibold rounded-lg hover:bg-violet-700 transition-colors"
          >
            Keşfet →
          </a>
        </div>
